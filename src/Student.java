public class Student {
    ...
    public void isPass() {
        this.average = (((this.c1.note * 0.8) + (this.c1.verbalNote * 0.2) + (this.c2.note * 0.8) + (this.c2.verbalNote * 0.2)) + ((this.c3.note * 0.8) + (this.c3.verbalNote * 0.2))) / 3;
        System.out.println("=====================================");
        if (this.average > 55) {
            System.out.println(this.name + "tebrikler sınıfı geçtiniz");
        } else {
